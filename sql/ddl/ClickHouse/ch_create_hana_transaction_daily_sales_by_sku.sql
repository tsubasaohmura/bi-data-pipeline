CREATE TABLE commercial.hana_transaction_daily_sales_by_sku
(
calday Date,
...
ORDER BY (calday, calday_prevyear, sales_region_code, sales_district_code, sales_branch_code, channel_l2_code, channel_l3_code, sku_code);