CREATE VIEW commercial.hana_sales_detail_alc ON CLUSTER prod_cluster
AS SELECT
    ...
    M1.zjregione AS sales_district_name_en,
    ...
    M1.zjresidne___t AS sales_center_name_english,
    M1.zjsrtanto AS sales_person_code,
    M1.zjsrtanto___t AS sales_person_name,
    M1.zjchncd AS ccej_channel_code,
    M1.zjchncd___t AS ccej_channel,
    M1.zjbjiclv1 AS channel_lv_1_code,
    M1.zjbjiclv1___t AS channel_lv_1,
    M1.zjbjiclv2 AS channel_lv_2_code,
    M1.zjbjiclv2___t AS channel_lv_2,
    M1.zjbjicl_m AS channel_lv_3_code,
    M1.zjbjicl_m___t AS channel_lv_3,
    M1.zjdlrc AS customer_code,
    M1.zjdlrc___t AS customer_name,
    M2.zjejbrand AS brand_code,
    M2.zjejbrand___t AS brand_name,
    M2.zjdbrdcd___t AS brand_name_en,
    M2.zjancd AS jan_code,
    M2.zjmatagsp AS product_code,
    M2.zjmatagg___t AS product_name,
    M2.zjddctcd AS ddis_container_type_code,
    M2.zjddctcd___t AS ddis_container_type_name,
    M2.zjddcscd AS ddid_container_size_code,
    M2.zjddcscd___t AS ddid_container_size_name,
    M2.zjpackcd AS ccej_package_code,
    M2.zjpackcd___t AS ccej_package_name,
    M2.zjddpkcd AS ddis_package_code,
    M2.zjddpkcd___t AS ddis_package_name,
...
FROM commercial.sales_detail AS T
    JOIN    (
        SELECT zjcust, zjdlrc___t, zjcust___t, zjdlrc, zjbjiclv1,
        zjbjiclv1___t, zjbjiclv2, zjbjiclv2___t, zjbjicl_m, zjbjicl_m___t,
        zjchncd, zjchncd___t, zjdivgcd, zjdivgcd___t, zjdivcd, zjdivcd___t,
        zjrgncd, zjrgncd___t, zjslsctcd, zjslsctcd___t, _zero_region,
        _zero_region___t, zjsreigp___t, zjsrtanto, zjsrtanto___t, zjresidne___t, zjregione
    FROM commercial.hana_master_zjcust_all
    ) M1 ON T.zjcustbrg = M1.zjcust
    JOIN    (
        SELECT zjmate, zjmatagsp, zjmatagg___t, zjancd, zjcatcd, zjcatcd___t,
        zjsbcatcd, zjsbcatcd___t, zjejbrand, zjejbrand___t, zjdbrdcd___t,
        zjddcscd, zjddcscd___t, zjddctcd, zjddctcd___t, zjpackcd, zjpackcd___t, zjddpkcd, zjddpkcd___t
