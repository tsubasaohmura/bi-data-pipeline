...
OUT_TABLE = "commercial.hana_transaction_daily_sales_for_mtd"
dates_list = create_datelist('2020-03-01', '2021-10-31')
...
GROUP BY
  ...
  "ZJDIVCD___T", "ZJBJICL_M___T", "ZJBJICLV2", "ZJBJICLV2___T", "ZJRGNCD", "ZJRGNCD___T"
UNION ALL
SELECT DISTINCT
  "BW_CALDAY_WEEK", 
  "0CALDAY_WEEK_prevyear", 
...
ORDER BY
  ...
  "CHIKU_HONBU", "BRANCH_NAME", "ZJBJICL_M"
;
"""
