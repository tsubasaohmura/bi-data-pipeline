...
with DAG(
    dag_id="hana_transaction_daily_sales_to_ch_v20210902",
    description="Extract transaction data from HANA and insert into ClickHouse",
    default_args=default_args,
    start_date=pendulum.datetime(2021, 9, 2, tzinfo=pendulum.timezone('Asia/Tokyo')),
    ...
    extract_hana_to_ch = PythonOperator(
        ...
        op_kwargs={
            ...
            'hana_sql_file': 'hana_transaction_daily_sales.sql',
            'ch_conn_id': 'clickhouse_commercial',
            'ch_target_table': 'commercial.hana_transaction_daily_sales',
            'truncate': False,
            'transaction':True,
            'daily_sales': True,
