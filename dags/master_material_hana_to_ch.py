...
with DAG(
    dag_id="master_material_hana_to_ch_v20201201",
    description="Extract partial material master data from HANA and load to ClickHouse",
    default_args=default_args,
    start_date=pendulum.datetime(2020, 12, 1, tzinfo=pendulum.timezone('Asia/Tokyo')),
    ...
    extract_hana_to_ch = PythonOperator(
        ...
        op_kwargs={
            ...
            'hana_sql_file': 'hana_zjmate_select_filtered.sql',
            'ch_conn_id': 'clickhouse_commercial',
            'ch_target_table': 'commercial.zjmate',
            'truncate': True
            },
