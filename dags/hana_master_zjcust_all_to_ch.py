...
with DAG(
    dag_id="hana_master_customer_all_to_ch_v20210518",
    description="Extract partial customer master data from HANA and load to ClickHouse",
    default_args=default_args,
    start_date=pendulum.datetime(2021, 5, 17, tzinfo=pendulum.timezone('Asia/Tokyo')),
    ...
    extract_hana_to_ch = PythonOperator(
        ...
        op_kwargs={
            ...
            'hana_sql_file': 'hana_master_zjcust_all.sql',
            'ch_conn_id': 'clickhouse_commercial',
            'ch_target_table': 'commercial.hana_master_zjcust_all',
            'truncate': True,
