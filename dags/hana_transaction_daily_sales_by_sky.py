...
with DAG(
    dag_id="hana_transaction_daily_sales_by_sku_to_ch_v20211103",
    description="Extract transaction data from HANA and insert into ClickHouse",
    default_args=default_args,
    start_date=pendulum.datetime(2021, 11, 2, tzinfo=pendulum.timezone('Asia/Tokyo')),
    ...
    extract_hana_to_ch = PythonOperator(
        ...
        op_kwargs={
            ...
            'hana_sql_file': 'hana_transaction_daily_sales_by_sku.sql',
            'ch_conn_id': 'clickhouse_commercial',
            'ch_target_table': 'commercial.hana_transaction_daily_sales_by_sku',
            'truncate': False,
            'transaction':True,
            'daily_sales': True,
